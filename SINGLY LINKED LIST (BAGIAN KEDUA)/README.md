...
// fungsi buat nyari pembeli berdasarkan nama
void cari_pembeli(string nama_dicari) {
   // cek dulu, kalo antrian kosong ngga usah dicari
   if (head == nullptr) {
      cout << "antrian kosong, ga ada data untuk dicari.\n";
      return;
   }
   ...
   // kondisi awalnya belum ketemu
   bool ketemu = false;

   // selama masih ada node
   while (temp != nullptr) {
      // bandingkan nama di node dengan nama yang dicari
